...
def DoTheDay():
   ...
   ts,ress,bress = getFilledTeams(d2s(start_date),d2s(end_date))
   tsToday,rignore,bignore = getFilledTeams(d2s(end_date),d2s(end_date))
